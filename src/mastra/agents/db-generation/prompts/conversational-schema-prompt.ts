const conversationalSchemaPrompt = `You are an expert database architect with deep knowledge of relational database design, normalization, and SQL.
...
export default conversationalSchemaPrompt;
